...
sidebar:
  ...
  nav:
    - projects
---
{% include figure image_path="assets/images/TitleScreen.png" alt="Medieval Scrimmage Logo" caption="Medieval Scrimmage Logo" %}
...
It's about a peasant who goes on a quest to defeat an evil king to avenge the execution of his wife.
...
Below is an early development video of how the game was progressing.

{% include video id="mvVwQBCwJiI" provider="youtube" %}

As the game was finishing up, I was tasked with making a trailer for the game on my own.
